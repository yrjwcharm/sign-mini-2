            ...
            <View style='display:flex;align-items:center;'>
              <View style='display:flex;flex-direction:column;'>
                <Input disabled={true} style='flex:1;text-align:right;'  type='text'   placeholder={'请选择开始时间'}
                       ...
                       <Input disabled={true} style='flex:1;text-align:right;margin-top:15PX'  type='text'   placeholder={'请选择结束时间'}
                       placeholderClass='list-row-input-placeholder'/>
              </View>
              <Image onClick={()=>decreaseSign(index)} src={Decrease} style='margin-left:7PX;width:20PX; height:20PX'/>
            </View>
          </View>
        </View>
